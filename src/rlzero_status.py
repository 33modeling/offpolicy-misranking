...
def main() -> None:
    ...
    if key_lines:
        print()
        print(" KEY NUMBERS per scored point: floor vs 2*chance is the point-estimate check (the paper gate uses its 95% lower bound); 'pinned' = scoring parked by rescoring")
