...
RULES: list[tuple[str, str, str]] = [
    ...
    (r"safetensors shard set incomplete|weight index contains no shards|neither a safetensors index",
     "shard files named by the index are not in the folder (see [locate] lines for what IS there)",
     "if *.safetensors exist there: git pull (>=58f586f) and rerun. If none: upload weights"),
