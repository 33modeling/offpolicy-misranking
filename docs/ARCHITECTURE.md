...
> **2026-08-31 해결:** 아래는 2026-08-24 당시 실측 기록이다. 현재
> `go_v4.sh <slot>`은 `go_offpolicy.sh`로 위임해 v4 재개, 7B regime, 단일 최종
> 집계를 모두 실행한다. regime/collect/harvest는 공유 잠금과 입력 키로 중복 실행을
> 차단한다.
